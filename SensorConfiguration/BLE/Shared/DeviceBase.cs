...
namespace Plugin.BLE.Abstractions
{
    ...
    public abstract class DeviceBase<TNativeDevice> : IDevice, ICancellationMaster
    {
        ...
        public abstract Task<bool> CreateBound();

        public bool SetPairingConfirmation(bool confirm)
        {
            return SetPairingConfirmationNative(confirm);
        }

        public abstract bool SetPairingConfirmationNative(bool confirm);
        public abstract bool IsConnectable { get; protected set; }

        public abstract bool SupportsIsConnectable { get; }
        public abstract bool SetPin(byte[] pin);
    }
}
