...
namespace Plugin.BLE.Abstractions
{
    ...
    public abstract class AdapterBase : IAdapter
    {
        ...
        private volatile bool _lowEnergyFlag;

        public bool LowEnergyFlag
        {
            get => _lowEnergyFlag;
            set => _lowEnergyFlag = value;
        }
        ...
        {
            return GetHostNameNaive();
        }

        protected abstract string GetHostNameNaive();
        ...
        protected abstract Task<bool> TurnOnNaive();
        ...
        protected abstract Task<bool> TurnOffNaive();

        public void HandleBounddDevice(IDevice device, DeviceBondState state)
        {
            if (state == DeviceBondState.Bonded)
            {
                DeviceBounded?.Invoke(this, new DeviceEventArgs { Device = device });
            }
        }
        public abstract IReadOnlyList<IDevice> GetBondedDevices();
